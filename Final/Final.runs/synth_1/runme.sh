...
HD_PWD='/media/jeffee/T7/vivado/Final/Final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_top_sub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_top_sub.tcl
