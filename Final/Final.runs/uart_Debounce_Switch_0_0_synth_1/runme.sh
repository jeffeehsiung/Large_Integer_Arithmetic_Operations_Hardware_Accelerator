...
HD_PWD='/media/jeffee/T7/vivado/Final/Final.runs/uart_Debounce_Switch_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_Debounce_Switch_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_Debounce_Switch_0_0.tcl
