...
HD_PWD='/media/jeffee/T7/vivado/lab3/lab3.runs/uart_uart_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_uart_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_uart_top_0_0.tcl
